...
folder = [currentFolder '/2. Codes/Main/results/MC_v6_1'];  % Change here for the MC results file
...
% saveas(gcf,[savefolder '/fig_MC_61_irf_compares.pdf'])
% saveas(gcf,[savefolder '/fig_MC_61_irf_compares.eps'],'epsc')
% saveas(gcf,[savefolder '/fig_MC_61_irf_compares.fig'],'fig')