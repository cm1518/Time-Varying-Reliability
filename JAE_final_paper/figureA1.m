...
%         patch_tmp = [mean(lb_IRF_Fixed(ii,:,:),3) flipdim(mean(ub_IRF_Fixed(ii,:,:),3),2)];
%         p_1b1 = patch(patch_axis,patch_tmp,[1 0 0],'EdgeColor','None');
...
% saveas(gcf,[savefolder '/fig_MC_51_irf_compares.pdf'])
% saveas(gcf,[savefolder '/fig_MC_51_irf_compares.eps'],'epsc')
% saveas(gcf,[savefolder '/fig_MC_51_irf_compares.fig'],'fig')