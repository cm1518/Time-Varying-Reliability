...
%saveas(gcf,[savefolder '/fig_MC_v51_beta_with_scaled_beta.pdf'])
%saveas(gcf,[savefolder '/fig_MC_v51_beta_with_scaled_beta.eps'],'epsc')
%saveas(gcf,[savefolder '/fig_MC_v51_beta_with_scaled_beta.fig'],'fig')
