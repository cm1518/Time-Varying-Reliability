...
% folders
folder1 = [currentFolder '/2. Codes/Main/results_lagsinproxyeq/' VAR_select ];
folder2 = [currentFolder '/2. Codes/Main/results/' VAR_select];
...
alpha(.5)
legend([p_1 p_2],{'no lags','with lags'},'Location','NorthEast'),legend boxoff
...
axis tight
grid('on'),box('on')
title('no lags versus with lags')
...
axis tight
grid('on'),box('on')
title('Reliability: no lags versus with lags')
