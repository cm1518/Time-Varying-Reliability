...
figure('Name','Gertler&Karadi'),orient('Landscape')

datechar=nDate(sample_iv_init_row(1,1):sample_iv_end_row(1,1),1);
plot(datechar,proxy{1,1},'k','LineWidth',linW)
dateFormat = 10;
datetick('x',dateFormat)
axis tight
grid on
title(['Gertler&Karadi Instrument'],'Interpreter','none')
xlabel('Time')
