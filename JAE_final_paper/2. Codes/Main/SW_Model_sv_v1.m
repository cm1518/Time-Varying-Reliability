...
erase_compiled_function('SW_Model_sv_v1_static');
erase_compiled_function('SW_Model_sv_v1_dynamic');
M_.orig_eq_nbr = 33;
M_.eq_nbr = 33;
M_.ramsey_eq_nbr = 0;
...
%
M_.exo_det_length = 0;
M_.Sigma_e(1, 1) = (0.2290)^2;
M_.Sigma_e(3, 3) = (0.3583)^2;
M_.Sigma_e(4, 4) = (0.6752)^2;
M_.Sigma_e(5, 5) = (0.5678)^2;
M_.Sigma_e(6, 6) = (0.2181)^2;
M_.Sigma_e(7, 7) = (0.2663)^2;
options_.irf = 49;
options_.nograph = 1;
options_.order = 1;
...
% save('SW_Model_sv_v1_results.mat', 'oo_', 'M_', 'options_');
% if exist('estim_params_', 'var') == 1
%   save('SW_Model_sv_v1_results.mat', 'estim_params_', '-append');
% end
% if exist('bayestopt_', 'var') == 1
%   save('SW_Model_sv_v1_results.mat', 'bayestopt_', '-append');
% end
% if exist('dataset_', 'var') == 1
%   save('SW_Model_sv_v1_results.mat', 'dataset_', '-append');
% end
% if exist('estimation_info', 'var') == 1
%   save('SW_Model_sv_v1_results.mat', 'estimation_info', '-append');
% end
% if exist('dataset_info', 'var') == 1
%   save('SW_Model_sv_v1_results.mat', 'dataset_info', '-append');
% end
% if exist('oo_recursive_', 'var') == 1
%   save('SW_Model_sv_v1_results.mat', 'oo_recursive_', '-append');
% end
% 
% 
