...
VAR_select_cell ={'gk_ff4_v1_fixed',...
                  };
...
SVAR=BPSVAR_Minn_PM0(data,proxy_v1,sample_vector,options_,priors);
...
SVAR=BPSVAR_Minn_PM0(data,proxy_v2,sample_vector,options_,priors);
