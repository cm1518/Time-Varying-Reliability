...
[priors,options_tmp1,q_s0_options,r_s0_options]=model_specs_data_combined_SV(VAR_select);
...
% sample_vector = [1 T];
seed=rng(100);
[SVAR, draws]=main_BTVPSVSVAR_Minn_func(data,proxy,sample_vector,options_,priors,q_s0_options,r_s0_options);
IRF=SVAR.LtildeFull;
