function [priors,options_,q_s0_options]=model_specs_data_combined_lagsinproxyeq(VAR_select)
...
case 'gk_ff4_v1_q_hcauchy'
        ...
        priors.a_prmean = zeros(5,1); % prior mean of coeffcients on lags of data in the proxy equation
        priors.a_prvar = 10*eye(5); % prior variance of coeffcients on lags of data in the proxy equation
case 'gk_mmiv1_v1_q_hcauchy'
        %%
        options_.i_var_str =  {'gs1','logcpi','logip','ebp'};
        options_.macro_var_str_names =  {'Gov Bond 1y', 'CPI', 'IP', 'Excess Bond Premium'}; % Name of variables (for plots)
        options_.macrovarSelec=[1:4];
