...
savefolder = [currentFolder '/results/MC_v6_1'];
mkdir(savefolder)   

load MC_v6_1_data.mat
...
rel=ones(246,1)*(kappa/(kappa+sigma_m^2));
rel(5:140,1)=1;
rel(150:230,1)=1;
...
parfor i=1:n_sims
    ...
    proxy{1,1}(:,1)=sqrt(kappa)*eMP+randn(T-options_.p,1)*sigma_m;
    proxy{1,1}(5:140,1)=sqrt(kappa)*eMP(5:140,1);
    proxy{1,1}(150:230,1)=sqrt(kappa)*eMP(150:230,1);
