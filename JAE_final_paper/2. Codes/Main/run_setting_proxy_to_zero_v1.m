...
[SVAR, draws]=main_BTVPSVAR_Minn_func(data,proxy_v1,sample_vector,options_,priors,q_s0_options);

IRF=SVAR.LtildeFull;
save([savefolder '/irf_proxy2zero_v1.mat'],'IRF')
save([savefolder '/post_proxy2zero_v1.mat'],'SVAR')


%% Estimating V2

[SVAR, draws]=main_BTVPSVAR_Minn_func(data,proxy_v2,sample_vector,options_,priors,q_s0_options);

IRF=SVAR.LtildeFull;
save([savefolder '/irf_proxy2zero_v2.mat'],'IRF')
save([savefolder '/post_proxy2zero_v2.mat'],'SVAR')
