...
var y pinf r ms ewma epinfma yf a b g qs spinf sw kpf kp cf invef c inve w lab zcapf rkf kf pkf labf wf rrf mc zcap rk k pk;    
...
stoch_simul(order=1,periods=1000,simul_replic=100,irf=49,irf_shocks=(em),nograph) y r pinf ms;
