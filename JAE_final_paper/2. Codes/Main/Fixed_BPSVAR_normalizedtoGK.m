...
addpath([currentFolder '/../auxfiles']);%% Preliminaries
...
[priors,options_tmp1]=model_specs_data_combined_fixed_coeff(VAR_select);
...
SVAR=BPSVAR_Minn_PM0(data,proxy,sample_vector,options_,priors);
IRF=SVAR.LtildeFull;
