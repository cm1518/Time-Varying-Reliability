...
[priors,options_tmp1,q_s0_options]=model_specs_data_combined_lagsinproxyeq(VAR_select);
...
% folders
savefolder = [currentFolder '/results_lagsinproxyeq/' VAR_select];
mkdir(savefolder)   
...
[SVAR, draws]=main_BTVPSVAR_x_Minn_func(data,proxy,sample_vector,options_,priors,q_s0_options);
IRF=SVAR.LtildeFull;
