function [residual, g1, g2, g3] = SW_Model_sv_v1_dynamic(y, x, params, steady_state, it_)
%
...
residual(25)= lhs-rhs;
lhs =y(30);
rhs =params(29)*y(10)+x(it_, 4)+x(it_, 2)*params(2);
residual(26)= lhs-rhs;
lhs =y(31);
rhs =params(31)*y(11)+x(it_, 5);
residual(27)= lhs-rhs;
lhs =y(24);
rhs =params(32)*y(4)+x(it_, 1);
residual(28)= lhs-rhs;
lhs =y(32);
