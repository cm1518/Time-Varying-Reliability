function [residual, g1, g2, g3] = SW_Model_sv_v1_static(y, x, params)
%
...
residual(23)= lhs-rhs;
lhs =y(8);
rhs =y(8)*params(26)+x(2);
residual(24)= lhs-rhs;
lhs =y(9);
rhs =y(9)*params(28)+x(3);
residual(25)= lhs-rhs;
lhs =y(10);
rhs =y(10)*params(29)+x(4)+x(2)*params(2);
residual(26)= lhs-rhs;
lhs =y(11);
rhs =y(11)*params(31)+x(5);
residual(27)= lhs-rhs;
lhs =y(4);
rhs =y(4)*params(32)+x(1);
residual(28)= lhs-rhs;
lhs =y(12);
...
T411 = 1-(T120/(1+T120)+1/(1+T120));
T413 = 1/(1-T120)-T120/(1-T120);
  g1(1,8)=1;
  g1(1,23)=(-params(9));
  g1(1,27)=(-(1-params(9)));
  g1(2,22)=1;
