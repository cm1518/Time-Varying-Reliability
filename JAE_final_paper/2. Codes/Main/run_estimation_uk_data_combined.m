...
options_tmp.nrep= 500000;                           % Number of draws in MC chain; 
options_tmp.burn_in = 0.5*options_tmp.nrep;          % Burn-in period
...
[priors,options_tmp1,q_s0_options]=uk_model_specs_data_combined(VAR_select);
...
IRF=SVAR.LtildeFull;
parsaveIRF([savefolder '\irf.mat'],IRF)
parsaveSVAR([savefolder '\post.mat'],SVAR)
