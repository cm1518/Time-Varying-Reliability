...
options_tmp.rwmh_sigma_prob = 0  ;                 % this is the mixture probability for the "RW" IG propsal on SIGMA
...
% 
% VAR_select_cell ={'gk_ff4_v1_q0_001','gk_ff4_v1_q0_01','gk_ff4_v1_q0_1',...
%                   'gk_rr_v1_q0_001','gk_rr_v1_q0_01','gk_rr_v1_q0_1',...
%                   'gk_ff4_rr_v1_q0_001','gk_ff4_rr_v1_q0_01','gk_ff4_rr_v1_q0_1',...
%                   'gk_mmiv1_v1_q0_001','gk_mmiv1_v1_q0_01','gk_mmiv1_v1_q0_1',...
%                   'gk_ff4_rr_mmiv1_v1_q0_001','gk_ff4_rr_mmiv1_v1_q0_01','gk_ff4_rr_mmiv1_v1_q0_1',...
%                   };
                

% VAR_select_cell ={'gk_ff4_v1_q_hcauchy','gk_ff4_v1_q_uniform',...
%                   'gk_rr_v1_q_hcauchy','gk_rr_v1_q_uniform',...
%                   'gk_mmiv1_v1_q_hcauchy','gk_mmiv1_v1_q_uniform',...
%                   'gk_ff4_rr_mmiv1_v1_q_hcauchy','gk_ff4_rr_mmiv1_v1_q_uniform'};


VAR_select_cell ={
                 'gk_ff4_v1_q_hcauchy',...
 %                'gk_rr_v1_q_hcauchy',...
 %                'gk_mmiv1_v1_q_hcauchy',...
 %                'gk_ff4_rr_mmiv1_v1_q_hcauchy',...
                  };
...
options_=[];
% Which VAR?
VAR_select = VAR_select_cell{1};

[priors,options_tmp1,q_s0_options]=model_specs_data_combined(VAR_select);
...
%% load data
load([savefolder '/irf.mat'])
load([savefolder '/post.mat'])


%% Setting proxy to zero
% first version: if PM0>0.5 proxy = 0
indc1=SVAR.PM0{1,1}>0.5;
proxy_v1= proxy;
proxy_v1{1,1}(indc1)=0;
percent_proxy2zero_v1 = sum(indc1)/length(indc1)


% second version: if PM0<=0.5 proxy = 0
indc2=SVAR.PM0{1,1}<=0.5;
proxy_v2= proxy;
proxy_v2{1,1}(indc2)=0;
percent_proxy2zero_v2 = sum(indc2)/length(indc2)
