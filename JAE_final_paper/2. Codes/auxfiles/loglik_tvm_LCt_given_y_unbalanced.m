function l =  loglik_tvm_LCt_given_y_unbalanced(m, u ,sample_vector, sigma_tr_t, omega, bet, signu)
...
M = size(m,1);
scale_mat = omega'./sigma_tr_t;

for t=1:size(u,2)
    e(:,t) = scale_mat(:,:,t)*u(t,:)'; % dimension 1 x T1
end
for i = 1:M
