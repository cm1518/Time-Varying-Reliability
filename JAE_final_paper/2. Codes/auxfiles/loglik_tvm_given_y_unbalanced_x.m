function l =  loglik_tvm_given_y_unbalanced_x(m, u ,sample_vector, sigma_tr, omega, bet, signu, x, a)
...
for i = 1:M
    ...
    z = m{i,1}' - bet{i,1}'.*e(1,sample_vector(i,1):sample_vector(i,2)) - a'*x(sample_vector(i,1):sample_vector(i,2),:)';
    z = z'./signu(i,1);
